...
public class yedi extends AppCompatActivity {
    ...
    public  void  ortalama(View view){
        ...
        ortalama = ((turkce*5)+(matematik*5)+(fen*4)+(sosyal*3)+(ingilizce*4)+(din*2)+(resim)+(music)+(beden*2)+(bilisim*2)+(sec1*x)+(sec2*y))/(29+x+y);
        Intent git = new Intent(yedi.this,sonuc.class);
