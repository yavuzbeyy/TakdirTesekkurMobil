...
public class lise extends AppCompatActivity {

    MediaPlayer mediaPlayer;
    float turkce,matematik,fen,sosyal,ingilizce,din,resim,music,beden,bilisim,demokrasi,ortalama;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lise);
    ...
    public  void  ortalama(View view){
        ...
        demokrasi = Float.parseFloat(secmeli.getText().toString());



        if (turkce<55 || matematik<45 || fen<45|| sosyal<45|| ingilizce<45|| din<45|| resim<45||
                music<45|| beden <45|| bilisim<45||demokrasi<45){
            kaldinmi = true;
        } else {
            kaldinmi = false;
        }
        ...
        ortalama = ((turkce*8)+(matematik*5)+(fen*3)+(sosyal*3)+(ingilizce*2)+(din*2)+(resim)+(music)+(beden*2)+(bilisim*1)+(demokrasi*2))/(30);
        Intent git = new Intent(lise.this,sonuc.class);
